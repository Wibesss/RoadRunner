      ...
      <div className="flex flex-col mt-2">
        ...
        {currentItems.length !== 0 && (
          <div className="flex justify-center mt-5">
            <button
              className="font-bold text-lg p-2 rounded-lg px-4 py-2 border-primary border-2 bg-primary text-white hover:bg-white hover:text-primary duration-300 text-center"
