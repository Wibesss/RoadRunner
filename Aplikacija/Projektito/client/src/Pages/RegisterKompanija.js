        ...
        <div className="my-1">
            ...
            <form className="max-w-lg mx-auto" onSubmit={registerKompanija}>
                ...
                <input type="email" placeholder={'unesiEmail@gmail.com'}
                    ...
                    />
                <input type="text" placeholder={'Krosinicko ime'}
                    value={userName}
                ...
                />
                <input type="text" placeholder={'Vlasnik(ime i prezime)'}
                    value={owner}
                ...
                />
                <button className={"bg-blue-300 text-white rounded-xl p-2 w-full my-5"}>Registruj se</button>
